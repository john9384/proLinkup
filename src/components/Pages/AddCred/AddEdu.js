        ...
        <div className="col-2-of-3 add-cred">
          ...
          <form className="form" onSubmit={this.onSubmit}>
            <InputField
              ...
              classname={
                errors && err_obj.field === "school"
                  ? "input add-cred__input input__error"
                  : "input add-cred__input"
              }
              info=""
              error={
                errors && err_obj.field === "school" ? err_obj.detail : null
              }
            />
            <InputField
              placeholder="Degree"
              ...
              onChange={this.onChange}
              classname={
                errors && err_obj.field === "degree"
                  ? "input add-cred__input input__error"
                  : "input add-cred__input"
              }
              info=""
              error={
                errors && err_obj.field === "degree" ? err_obj.detail : null
              }
            />
            <InputField
              type="text"
              ...
              onChange={this.onChange}
              classname={
                errors && err_obj.field === "fieldofstudy"
                  ? "input add-cred__input input__error"
                  : "input add-cred__input"
              }
              info=""
